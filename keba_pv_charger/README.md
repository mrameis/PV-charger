...
dem Dashboard jetzt zusätzlich ein „Speicher"-Knoten mit aktueller Lade-/Entladeleistung
und der Solar-Ladeleistung (bei Victron: der DC-gekoppelte MPPT-Wert). Bei mehreren
Batteriegeräten werden die Werte summiert.
